...
*MeNUS* is an all in one restaurant management desktop application targeted for restaurant owners in National
University of Singapore (NUS). It is developed to help restaurant owners streamline the process of managing restaurants
and help them save cost from running expensive and independent systems.
