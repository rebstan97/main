...
Ranks the menu items based on their total revenue accumulated in descending order +
Format: `rank-dish`

=== Ranking dates according to profitability: `rank-date`

Ranks the dates based on their revenue accumulated in descending order +
Format: `rank-date`
