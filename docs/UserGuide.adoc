...
== Introduction
link:{repoURL}[MeNUS] empowers you in improving the Management(M) and its efficiency(e) of your
restaurants in NUS.
...
=== Adding a sales record: `record-sales`

Records the quantity of an item sold within a specific day into the sales book. +
...
=== Ranking items according to total revenue: `rank-item`
...
|*Add sales record* |`record-sales d/DATE n/ITEM_NAME q/QUANTITY SOLD p/ITEM_PRICE` |`record-sales d/25-09-2018 n/Fried Rice q/35 p/5.50`
