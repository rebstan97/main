...
e.g. `login id/azhikai pw/1122qq`
* *Logging out*: `logout`
* *Creating user account*: `register id/USERNAME pw/PASSWORD` +
e.g. `register id/azhikai pw/1122qq`
* *Editing user account*: `edit-acc id/USERNAME [nid/NEW_USERNAME] [pw/NEW_PASSWORD]` +
e.g. `edit-acc id/azhikai nid/angzhikai`
* *Deleting user account*: `deregister id/USERNAME` +
e.g. `deregister id/azhikai`
...
* *Select item* : `select-items INDEX`
e.g. `select-item 3`
