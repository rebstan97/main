...
|`* * *` |restaurant owner |add a new item to the menu |

|`* * *` |restaurant owner |delete a item from the menu |remove entries that I no longer need

|`* * *` |restaurant owner |edit a item from the menu |update the entries of the menu

|`* * *` |restaurant owner |find a item by name |locate details of items without having to go through the entire
 list

|`* * *` |restaurant owner |filter items by tag |filter and find items without having to go through the entire list

|`* * *` |restaurant owner |give a item discount |have discount for items in menu
...
[discrete]
=== Use case: UC501 - Record sales volume of menu item within a day

*Guarantees*:

* A new sales record of a menu item will be appended.

*MSS*

1. User requests to record sales volume of a menu item within a specified day.
2. App appends the record at the end of the day's sales report.
...
[none]
* 2a. Sales report does not exist for the specified day.
[none]
** 2a1. App automatically creates a sales report for the day.
+
Use case resumes at step 2.

* 2b. Sales record of the menu item already exist in the day's sales report.
[none]
** 2b1. App returns a message telling user that the menu item's record already exists.
** 2b2. User requests to record sales volume again.
+
Steps 2b1-2b2 are repeated until a record with unique item name is entered.
+
Use case resumes at step 3.
+
...
[discrete]
=== Use case: UC502 - Editing sales record in a sales report for a day
...
1. User requests to edit a sales record in the sales report for a specified day.
...
[none]
* 1b. The given index/name is invalid.
+
[none]
** 1b1. App returns a message telling user that the index/name is invalid.
** 1b2. User requests to edit sales record again.
+
Steps 1b1-1b2 are repeated until a valid index/name is entered.
+
Use case resumes at step 2.
...
[discrete]
=== Use case: UC503 - Deleting sales record in a sales report for a day

*MSS*

1.  User requests to display the sales report of a specified day.
2.  App shows the sales report.
3.  User requests to delete a sales record in that sales report.
4.  App deletes the sales record.
5. App returns a success message confirming that the deletion is successful.
+
Use case ends.
...
[none]
* 1a. The sales report does not exist in the specified day since no record has been entered.
* 1b. App tells user that sales report does not exist.
+
Use case ends.

* 3a. Invalid command format entered by the user.
[none]
** 3a1. App returns a message telling user that the command format is invalid.
** 3a2. User requests to delete sales record again.
+
Steps 3a1-3a2 are repeated until a valid command format is entered.
+
Use case resumes at step 4.
+

* 3b. The given index/name is invalid.
+
[none]
** 3b1. App returns a message telling user the index/name is invalid.
** 3b2. User requests to delete sales record again.
+
Steps 3b1-3b2 are repeated until a valid index/name is entered.
+
Use case resumes at step 4.
...
*Extensions*
[none]
* 1a. User has never entered a sales record. No sales record exists.
[none]
** 1a1. App returns a message telling user that there is no sales record.
+
Use case ends.
