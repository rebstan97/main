...
image::DeleteIngByIndexSequenceDiagram.png[width="1000"]

* Diagram 2: When user enters `delete-ingredient apple`

image::DeleteIngByNameSequenceDiagram.png[width="1000"]
...
[none]
* 2b. The user enters an invalid command or invalid command format.
[none]
** 2b1. App returns a message telling user that the command or command format is invalid.
** 2b2. User requests to add ingredient again.
+
Steps 2b1-2b2 are repeated until an ingredient name which does not exist is used.
+
Use case resumes at step 3.
...
[none]
* 3b. The ingredient name is invalid.
[none]
** 3b1. App returns a message telling user that the ingredient name entered is invalid.
** 3b2. User requests to delete ingredient again.
+
Steps 3b1-3b2 are repeated until a valid ingredient name is entered.
+
Use case resumes at step 4.

[none]
* 3c. The ingredient name does not exist.
[none]
** 3c1. App returns a message telling user that the ingredient cannot be not found.
** 3c2. User requests to delete ingredient again.
+
Steps 3c1-3c2 are repeated until an existing ingredient name is entered.
+
Use case resumes at step 4.
