...
. Open link:{repoURL}/src/main/java/seedu/address/storage/XmlAdaptedAccount.java[`XmlAdaptedAccount.java`] and
link:{repoURL}/src/main/java/seedu/address/ui/MainWindow.java[`MainWindow.java`] and check for any code errors
