...
import static seedu.address.logic.commands.CommandTestUtil.VALID_DATE_RECORD_THREE;
...
import static seedu.address.logic.commands.CommandTestUtil.VALID_ITEM_NAME_RECORD_THREE;
...
import static seedu.address.logic.commands.CommandTestUtil.VALID_QUANTITY_SOLD_RECORD_THREE;
...
public class TypicalRecords {
    ...
    public static final SalesRecord RECORD_ONE = new RecordBuilder().withDate(VALID_DATE_RECORD_ONE)
            .withName(VALID_ITEM_NAME_RECORD_ONE).withQuantitySold(VALID_QUANTITY_SOLD_RECORD_ONE).
                    withPrice(VALID_PRICE_RECORD_ONE).build();
    public static final SalesRecord RECORD_TWO = new RecordBuilder().withDate(VALID_DATE_RECORD_TWO)
    ...
    public static final SalesRecord RECORD_THREE = new RecordBuilder().withDate(VALID_DATE_RECORD_THREE)
            .withName(VALID_ITEM_NAME_RECORD_THREE).withQuantitySold(VALID_QUANTITY_SOLD_RECORD_THREE).
